...
//    }
    ...
    public String diff(ContextPropertyInfo b) {
        ...
        if (multivalued != b.multivalued)
            result.append(" multivalued: ").append(multivalued).append(" vs ").append(b.multivalued);
        ...
        if (structured != b.structured)
            result.append(" structured: ").append(structured).append(" vs ").append(b.structured);
