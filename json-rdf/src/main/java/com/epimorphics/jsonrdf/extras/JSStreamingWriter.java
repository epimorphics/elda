...
public class JSStreamingWriter {
    ...
    public JSStreamingWriter() {
        this(IndentedWriter.stdout);
    }

    public JSStreamingWriter(Writer w) {
        this(new IndentedWriter(w));
    }

    public JSStreamingWriter(OutputStream ps) {
        this(new IndentedWriter(ps));
    }

    public JSStreamingWriter(IndentedWriter ps) {
        out = ps;
    }
