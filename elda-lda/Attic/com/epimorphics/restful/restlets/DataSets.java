...
public class DataSets {
    ...
    public String renderAllDatasetsAsJSON() {
    ...
    @GET
    @Produces("text/html")
    public String displayAllDatasets() {
        Model m = ModelState.getModel();
    ...
    @Path("/{id}")
    @Produces("text/html")
    public String displayDataset(@PathParam("id") String id) {
        Model m = ModelState.getModel();
    ...
    @Path("/{id}")
    @Produces("application/json")
    public String datasetAsJSON(@PathParam("id") String id) {
        Model m = ModelState.getModel();
        CatalogueInJSON cj = new CatalogueInJSON(config);
        Resource r = m.listSubjectsWithProperty(DSV.hasID, id).next();
