...
//        return "@";
    ...
    private RDFNode decodeNumber(JsonNumber jn) {
        ...
        try {
            return ResourceFactory.createTypedLiteral(bd.intValueExact());
        } catch (ArithmeticException e) { /* fall through on exception */ }
        try {
            return ResourceFactory.createTypedLiteral(bd.longValueExact());
        } catch (ArithmeticException e) { /* fall through on exception */ }
        try {
            return ResourceFactory.createTypedLiteral(bd.doubleValue());
        } catch (ArithmeticException e) { /* fall through on exception */ }
