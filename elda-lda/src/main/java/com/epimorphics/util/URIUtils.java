...
public class URIUtils {
    ...
    public static URI replaceQueryParam(URI ru, String key, String... values) {
        return UriBuilder.fromUri(ru).replaceQueryParam(key, (Object[]) values).build();
    }
    ...
    private static String appendSuffix(String oldPath, String newSuffix) {
        return newSuffix.isEmpty() ? oldPath : oldPath + "." + newSuffix;
    }
    ...
    public static URI changeFormatSuffix(URI reqURI, List<String> knownFormats, String formatName) {
        ...
        return UriBuilder.fromUri(reqURI).replacePath(newPath).build();
    }
