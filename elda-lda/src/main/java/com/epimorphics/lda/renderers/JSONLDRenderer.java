...
public class JSONLDRenderer implements Renderer {
    ...
    @Override
    public MediaType getMediaType(Bindings ignored) {
        return mt;
    }
    ...
    @Override
    public BytesOut render(Times t, Bindings rc, final Map<String, String> termBindings, final APIResultSet results) {
        ...
        return new BytesOutTimed() {
            ...
            @Override
            protected void writeAll(OutputStream os) {
                try {
