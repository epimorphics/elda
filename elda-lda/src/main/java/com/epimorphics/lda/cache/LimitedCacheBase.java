...
//       	System.err.println( ">> removing expired key '" + uri + "'" );
    ...
    @Override
    public synchronized void store(URI uri, ResponseResult toStore, long expiresAt) {
//    	System.err.println( ">> caching " + uri + " until " + RouterRestletSupport.expiresAtAsRFC1123(expiresAt));
    ...
    @Override
    public synchronized TimedThing<APIResultSet> getCachedResultSet(List<Resource> results, String view) {
...
//        	 System.err.println( ">> removing expired key '" + key + "'" );
    ...
    @Override
    public synchronized List<Resource> getCachedResources(String select) {
    ...
    @Override
    public synchronized void cacheDescription(List<Resource> results, String view, APIResultSet rs, long expiresAt) {
    ...
    @Override
    public synchronized void cacheSelection(String select, List<Resource> results, long expiresAt) {
        if (log.isDebugEnabled()) {
     ...
     */
    @Override
    public synchronized int getCount(String countQueryString) {
     ...
     */
    @Override
    public synchronized void putCount(String countQueryString, int count, long expiresAt) {
