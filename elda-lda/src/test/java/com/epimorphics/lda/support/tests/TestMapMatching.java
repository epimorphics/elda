...
public class TestMapMatching {
    @Test
    public void ensureEmptyMapProducesEmptySet() {
    ...
    @Test
    public void ensureAbsentKeysProduceEmptySetA() {
    ...
    @Test
    public void ensurePresentKeyProducesSingletonSet() {
    ...
    @Test
    public void ensurePresentKeyListProducesMultipleSet() {
    ...
    @Test
    public void ensureMultipleRelatedKeysProduceResults() {
    ...
    @Test
    public void ensureMultipleListyKeysAllAppear() {
