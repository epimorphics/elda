...
public class TestCaches {
    ...
    @Test
    public void testLimitEntriesCache() {
    ...
    @Test
    public void testLimitTriplesCache() {
     ...
     */
    @Test
    public void testExpiryTimingLimitTriples() {
    ...
    @Test
    public void testExpiryTimingLimitEntries() {
    ...
    @Test
    public void testExpiryTimingResourcesLimitTriples() {
    ...
    @Test
    public void testExpiryTimingResourcesLimitEntries() {
