...
public class TestAPISpecExtractPrefixMapping {
    ...
    @Test
    public void testWithNoMappings() {
    ...
    @Test
    public void testWithOnlyModelPrefixMappings() {
        testWithOnlyModelMappings(makeMapping(""));
    }

    @Test
    public void testWithOnlyOneModelPrefixMapping() {
        testWithOnlyModelMappings(makeMapping("a=eh:/A#"));
    }

    @Test
    public void testWithOnlyTwoModelPrefixMappings() {
    ...
    @Test
    public void testWithTwoMappingsInModel() {
        String modelString =
