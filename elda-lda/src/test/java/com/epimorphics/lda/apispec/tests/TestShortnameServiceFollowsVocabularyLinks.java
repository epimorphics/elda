...
public class TestShortnameServiceFollowsVocabularyLinks {
    ...
    @Test
    public void testRecognisesDatatypesInSpec() {
    ...
    @Test
    public void testRecognisesDatatypesFromVocab() {
        Resource root = namesModel.createResource("fake:root");
        ShortnameService sns = new StandardShortnameService(root, namesModel, loader);
        assertFalse(":nowhere should not be a datatype", sns.isDatatype(NS + "nowhere"));
    ...
    @Test
    public void testRecognisesImplicitDatatypeFromVocab() {
        Resource root = namesModel.createResource("fake:root");
        ShortnameService sns = new StandardShortnameService(root, namesModel, loader);
        assertFalse(":nowhere should not be a datatype", sns.isDatatype(NS + "nowhere"));
    ...
    @Test
    public void testRecognisesLabelsInSpec() {
        Resource root = namesModel.createResource("fake:root");
        ShortnameService sns = new StandardShortnameService(root, namesModel, loader);
    ...
    @Test
    public void testRecognisesLabelsFromVocab() {
        Resource root = namesModel.createResource("fake:root");
        ShortnameService sns = new StandardShortnameService(root, namesModel, loader);
    ...
    @Test
    public void testSpecOverridesVocabName() {
        Resource root = namesModel.createResource("fake:root");
        ShortnameService sns = new StandardShortnameService(root, namesModel, loader);
    ...
    @Test
    public void testSeePropertyFromConfig() {
