...
public class TestBindsDefaultFormatterSuffix {
    ...
    @Test
    public void requireNoDefaultFormatterMeansNoDefaultSuffix() {
        testSpecDefaultSuffix(null, "");
    }

    @Test
    public void requireOneDefaultFormatterMeansThatDefaultSuffix() {
    ...
    @Test
    public void requireOneDefaultFormatterMeansThatDefaultSuffixWithEndpointFormatters() {
        testSpecDefaultSuffix
                ("xyzzy"
                        , ":my api:defaultFormatter [a elda:VelocityFormatter; api:mimeType 'text/plain'; api:name 'xyzzy']."
                                + "\n:my api:endpoint :A."
    ...
    @Test
    public void requireEndpointDefaultFormatterMeansThatDefaultSuffixWithEndpointFormatters() {
    ...
    @Test
    public void requireEndpointDefaultFormatterInheritsSpecDefaultSuffix() {
        testEndpointDefaultSuffix
                ("xyzzy"
                        , ":my api:defaultFormatter [a elda:VelocityFormatter; api:mimeType 'text/plain'; api:name 'xyzzy']."
                                + "\n:my api:endpoint :A."
    ...
    @Test
    public void requireEachEndpointHasItsOwnDefaultSuffix() {
