...
public class TestBindings {
     ...
     */
    @Test
    public void testDeclaredVariablesCanDependOnURIMatches() throws URISyntaxException {
        String specString =
...
//		System.err.println( ">> " + sq );
    ...
    @Test
    public void testBindingsCarryGeneralObjects() {
    ...
    @Test
    public void testBindingsCopyGeneralObjects() {
        Bindings b = new Bindings();
