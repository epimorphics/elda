...
public class TestParseLicenceConfig {
    ...
    @Test
    public void testParseEmptyLicenceConfig() {
        setBaseConfig();
    ...
    @Test
    public void testParseAPILicenceConfig() {
        setBaseConfig();
    ...
    @Test
    public void testParseEndpointLicenceConfig() {
        setBaseConfig();
    ...
    @Test
    public void testParseAPIandEndpointLicenceConfig() {
        setBaseConfig();
        model.add(root, ELDA_API.license, "this.is.a.path");
        model.add(theEndpoint, ELDA_API.license, aLicenceResource);
