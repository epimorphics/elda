...
public class TestWrappedStrings {
    ...
    @Ignore @Test public void ensureRawAndCookedValuesAvailable() {
    ...
    @Ignore @Test public void ensurePerformsSpaceBreaks() {
    ...
    @Ignore @Test public void ensureCutRespectsBoundaries() {
