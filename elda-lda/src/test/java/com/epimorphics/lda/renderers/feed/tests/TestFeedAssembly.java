...
public class TestFeedAssembly {
    ...
    @Test
    public void testDefaultDateProperties() {
        FeedRenderer fr = makeFeedRenderer(config);
    ...
    @Test
    public void testConfiguredSingleDateProperties() {
    ...
    @Test
    public void testConfiguredMultiDateProperties() {
    ...
    @Test
    public void testConfiguredSingleLabelProperties() {
    ...
    // assumes there are at least two default date properties
    @Test
    public void testConfiguredMultiLabelProperties() {
    ...
    @Test
    public void testDefaultRightsProperties() {
        FeedRenderer fr = makeFeedRenderer(config);
        assertEquals(defaultRightsProperties, fr.getRightsProperties());
    }

    @Test
    public void testDeConfiguredRightsProperties() {
    ...
    @Test
    public void testDefaultFeedRights() {
        FeedRenderer fr = makeFeedRenderer(config);
        assertNull(fr.getFeedRights());
    }

    @Test
    public void testConfiguredFeedRights() {
    ...
    @Test
    public void testDefaultAuthors() {
        FeedRenderer fr = makeFeedRenderer(config);
        assertTrue(fr.getAuthors().isEmpty());
    }

    @Test
    public void testConfiguredAuthors() {
    ...
    @Test
    public void testDefaultAuthorProperties() {
        FeedRenderer fr = makeFeedRenderer(config);
        assertEquals(defaultAuthorProperties, fr.getAuthorProperties());
    }

    @Test
    public void testConfiguredAuthorProperties() {
        Property a = configModel.createProperty("eh:/A");
        Property b = configModel.createProperty("eh:/B");
        //
    ...
    @Test
    public void testRendersFeedAuthorsIfPresent() {
    ...
    @Test
    public void testRendersManagesCyclesIfPresent() {
    ...
    @Test
    public void testRendersEntryAuthorsIfPresent() {
        Property a = configModel.createProperty("eh:/author_A");
        Property b = configModel.createProperty("eh:/author_B");
        RDFNode[] properties = new RDFNode[]{a, b};
        RDFList authors = configModel.createList(properties);
    ...
    @Test
    public void testRendersFeedRightsIfPresent() {
    ...
    @Test
    public void testRendersEntryRightsIfPresent() throws XpathException {
    ...
    @Test
    public void testConfiguredNamespace() {
    ...
    @Test
    public void testNamespaceEmbedsInContent() {

    }

    @Test
    public void testSingleItemXMLrendering() throws XpathException {
        FeedRenderer fr = makeFeedRenderer(config);
