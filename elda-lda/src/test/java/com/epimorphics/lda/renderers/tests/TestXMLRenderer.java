...
//		System.err.println( ">> " + parse( "(hello href=spoo)" ) );
    ...
    @Test
    public void testSingleDataStatement() {
    ...
    @Test
    public void testSortingByPredicate() {
    ...
    */
    @Test
    public void testUnpackingRepeatedResources() {
    ...
    @Test
    public void testRootWithSingletonList() {
    ...
    @Test
    public void testRootWithDoubletonList() {
        ensureWrappedRendering
