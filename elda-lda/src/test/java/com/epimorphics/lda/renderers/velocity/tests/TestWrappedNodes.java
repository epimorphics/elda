...
public class TestWrappedNodes {
    ...
    @Ignore @Test public void ensureItemPreservesResourceURI() {
        IdMap ids = new IdMap();
...
//	}
    ...
    @Ignore @Test public void ensureLabels() {
    ...
    @Ignore @Test public void ensure_finds_properties() {
    ...
    @Ignore @Test public void ensure_finds_inverse_properties() {
        WrappedNode.Bundle b = new WrappedNode.Bundle( sn,  new IdMap() );
        Model m = ModelFactory.createDefaultModel();
    ...
    @Ignore @Test public void ensure_follows_inverse_properties() {
        WrappedNode.Bundle b = new WrappedNode.Bundle( sn,  new IdMap() );
        Model m = ModelFactory.createDefaultModel();
    //
        Resource Sa = m.createResource( NS + "Sa" );
