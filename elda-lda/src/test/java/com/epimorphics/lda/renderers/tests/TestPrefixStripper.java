...
public class TestPrefixStripper {
    ...
    @Test
    public void testVisitsSubject() {
        A.add(S, none, none);
        check();
    }

    @Test
    public void testVisitsPredicate() {
        A.add(none, P, none);
        check();
    }

    @Test
    public void testVisitsResourceObject() {
        A.add(none, none, O);
        check();
    }

    @Test
    public void testVisitsLiteralObject() {
        A.add(none, none, OLiteral);
        checkLiteral();
    }

    @Test
    public void testVisitsTypedObject() {
