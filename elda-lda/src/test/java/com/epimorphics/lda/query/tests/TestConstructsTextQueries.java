...
public class TestConstructsTextQueries {
    ...
    @Test
    public void testConstructsSimpleQuery() {
        testConstructsSimpleSearchTriples(TextSearchConfig.JENA_TEXT_QUERY);
    }

    @Test
    public void testConstructsSimpleConfiguredQuery() {
    ...
    @Test
    public void testUsesConfiguredTextProperty() {
    ...
    @Test
    public void testUsesConfiguredTextOperand() {
        int number = 17;
