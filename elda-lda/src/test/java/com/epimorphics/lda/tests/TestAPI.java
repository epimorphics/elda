...
public class TestAPI {
	...
	@Test public void testFilterQueries() {
		// string case
	...
	@Test public void testFilterInSpec() {
	...
	@Test public void testNameQuery() {
	...
	@Test public void testURLTemplateQuery() {
		testAPI("http://dummy/doc/schools/type/Primary", "", "testTypePrimary.ttl");
	}

	@Test public void testURLTemplateQueryLiteral() {
		testAPI("http://dummy/doc/schools/la/BANES", "", "testLABanes.ttl");
		// Same thing expressed using where clause, revealed a bug in variable
		// binding for where clauses
	...
	@Test public void testJSONInteractionBug() {
		APIResultSet rs = testAPI("http://dummy/doc/schools", "size=200&_view=all", "testFilterSize200.ttl");
		tester.renderAsJSON(apiName, rs);
		testAPI("http://dummy/doc/schools", "school_type=Primary&_view=all", "testFilterPrimary.ttl");
	}

	@Test public void testSingleSubjectQuery() {
		// testAPI("http://dummy/doc/schools", "_subject=ex_school_1&_view=all",
		// "testSchool1.ttl");
	...
	@Test public void testExpansionTemplates() {
		testAPI("http://dummy/doc/schools", "_properties=name,size", "testTemplateNameSize.ttl");
	...
	@Test public void testTypedURLParams() {
