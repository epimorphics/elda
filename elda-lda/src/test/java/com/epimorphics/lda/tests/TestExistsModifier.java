...
public class TestExistsModifier {
    private static final class Shorts extends ExpandOnly {
        ...
        @Override
        public Resource asResource(String shortName) {
    ...
    public void testNotExists() {
        ...
        RDFQ.Tree inner = new ArrayList<>(optionals.nested.entrySet()).getFirst().getValue();
    ...
    @Test
    public void testExistsBackwardsTrueFinds_FakeS() {
        testNotExistsXY("true", "fake:S");
    }

    @Test
    public void testExistsBackwardsFalseFinds_FakeT() {
