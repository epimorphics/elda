...
public class TestCallContext {
    @Test
    public void ensureContextCreatedEmptyIsEmpty() {
...
//		assertThat( cc.getUriInfo(), sameInstance(ui) );
    ...
    @Test
    public void ensureContextRecallsParameterNames() {
...
//		assertThat( cc.getUriInfo(), sameInstance(ui) );
    ...
    @Test
    public void ensureContextRecallsBindingNames() {
        MultiMap<String, String> map = MakeData.parseQueryString("");
...
//		assertThat( cc.getUriInfo(), sameInstance(ui) );
    ...
    @Test
    public void ensureContextGetsAppropriateValues() {
...
//		assertThat( cc.getUriInfo(), sameInstance(ui) );
    ...
    @Test
    public void ensureCopyingConstructorPreservesValues() {
        MultiMap<String, String> map = MakeData.parseQueryString("p1=v1&p2=v2");
