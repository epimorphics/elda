...
public class TestMatchingTemplates {
    ...
    @Test
    public void testTemplateSorting() {
    ...
    @Test
    public void ensure_searcher_finds_correct_value() {
    ...
    @Test
    public void ensure_matching_for_fixed_query_parameters() {
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void testing_template_with_big_query_parameter_patterns() {
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void testing_template_with_big_multiple_parameter_patterns() {
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void testing_template_with_big_multiple_parameter_patterns2() {
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void testing_template_with_big_multiple_parameter_patterns3() {
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void ensure_matching_for_variable_query_parameters() {
        MatchSearcher<String> r = new MatchSearcher<String>();
        Map<String, String> bindings = new HashMap<String, String>();
        MultiMap<String, String> params = new MultiMap<String, String>();
        r.register("/anchor?k={v}", "A");
    ...
    @Test
    public void ensure_MatchSearcher_can_remove_template() {
        Map<String, String> b = new HashMap<String, String>();
        MatchSearcher<String> r = new MatchSearcher<String>();
    ...
    @Test
    public void ensure_matching_captures_variables() {
