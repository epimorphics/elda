...
public class TestAPITemplate {
    ...
    @Test
    public void testDefaultTemplateInSpec() {
        testTemplate
                (""
    ...
    @Test
    public void testDefaultTemplateInEndpoint() {
        testTemplate
                (""
                        , ""
                        , "; api:defaultViewer [api:template '?item :predicate ?v']"
    ...
    @Test
    public void testNamedTemplateInSpec() {
        testTemplate
                ("_view=NAMED"
    ...
    @Test
    public void testNamedTemplateInEndpoint() {
        testTemplate
                ("_view=NAMED"
                        , ""
                        , "; api:viewer [api:name 'NAMED'; api:template '?item :predicate ?v']"
