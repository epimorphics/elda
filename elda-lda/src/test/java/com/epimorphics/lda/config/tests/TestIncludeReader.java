...
public class TestIncludeReader {
    ...
    @Test
    public void testIncludeReaderTriple() throws IOException {
    ...
    @Test
    public void testIncludeReaderException() throws IOException {
        Model m = ModelFactory.createDefaultModel();
