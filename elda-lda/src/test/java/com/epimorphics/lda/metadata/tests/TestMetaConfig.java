...
public class TestMetaConfig {
    ...
    @Test
    public void testEnablePropertiesConfigAbsent() {
        testEnablePropertiesConfig(false, false, "");
    }

    @Test
    public void testEnablePropertiesConfigFalse() {
        testEnablePropertiesConfig(false, false, "; elda:disable-default-metadata false");
    }

    @Test
    public void testEnablePropertiesConfigTrue() {
    ...
    @Test
    public void testBuildMetadataBlockNoSubst() {
    ...
    @Test
    public void testBuildMetadataBlockWithSubst() {
    ...
    @Test
    public void testBuildMetadataBlockWithResource() {
        Bindings b = new Bindings().put("B", "X");
    ...
    @Test
    public void testBuildMetadataBlockError() {
        Bindings b = new Bindings().put("B", "X");
