...
public class TestURIUtils {
    ...
    @Test
    public void toHoldASpecialCharacter() {
        @SuppressWarnings("unused") URI u = newURI("http://example.com/spa%20cé");
    }

    @Test
    public void testReplacesKnownFormat() {
    ...
    @Test
    public void testPreservesUnknownFormat() {
        URI req = newURI("http://example.com/anchor/thing.rdf");
    ...
    @Test
    public void testChangeFormatSuffixPreservesEncoding() {
    ...
    @Test
    public void testURISlashlessFragment() {
    ...
    static class Case {
        ...
        Case(String e, String a, String r, String u) {
            expect = e;
            apiBase = a;
            requestURI = r;
            uiPath = u;
    ...
    @Test
    public void testBuildsExpectedURI() {
