...
public class TestMediaType {
    @Test
    public void ensureMediaTypeRespectsEquals() {
    ...
    @Test
    public void ensureMediaTypeDoesAccept() {
    ...
    @Test
    public void ensureMediaTypeDoesReject() {
    ...
    @Test
    public void ensureMediaTypeRejectsBithWildcard() {
