...
public class TestDynamicReload extends TomcatTestBase {
    ...
    @Test
    public void testDynamicReload() throws ClientProtocolException, IOException, InterruptedException {
        if (runTests) testDynamicReload("elda-config.ttl");
    }

    @Test
    public void testIncludeDynamicReload() throws ClientProtocolException, IOException, InterruptedException {
