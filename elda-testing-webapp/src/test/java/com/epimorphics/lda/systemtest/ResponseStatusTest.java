...
public class ResponseStatusTest extends TomcatTestBase {
    ...
    @Test
    public void testApiConfig() throws ClientProtocolException, IOException {
        Util.testHttpRequest("api-config", 200, Util.ignore);
    }

    // test that a call to api-config succeeds after a endpoint call
    @Test
    public void testApiConfig2() throws ClientProtocolException, IOException {
        Util.testHttpRequest("games", 200, Util.ignore);
        Util.testHttpRequest("api-config", 200, Util.ignore);
    }

    @Test
    public void testSimpleFilter() throws ClientProtocolException, IOException {
        Util.testHttpRequest("games", 200, Util.ignore);
    }

    @Test
    public void testUnknownPropertyGeneratesBadRequest() throws ClientProtocolException, IOException {
        Util.testHttpRequest("games?nosuch=10", EldaException.BAD_REQUEST, Util.ignore);
    }

    @Test
    public void testCallbackWithNonJSONGeneratesBadRequest() throws ClientProtocolException, IOException {
        Util.testHttpRequest("games.html?callback=wrong", EldaException.BAD_REQUEST, Util.ignore);
    }

    @Test
    public void testCallbackWithJSONReturnsStatusOK() throws ClientProtocolException, IOException {
        Util.testHttpRequest("games.json?callback=right", 200, Util.ignore);
    }

    @Test
    @Ignore
    public void testShowItemSucceeds() throws ClientProtocolException, IOException {
        Util.testHttpRequest("show/item/A", 200, Util.ignore);
    }

    @Test
    public void testMatchingItemTemplateGeneratesRedirection() throws ClientProtocolException, IOException {
        Util.testHttpRequest("item/A", 303, Util.ignore);
    }

    @Test
    public void testThingAccessIsOK() throws ClientProtocolException, IOException {
        Util.testHttpRequest("things", 200, Util.ignore);
    }

    @Test
    public void testLanguageCodes() throws ClientProtocolException, IOException {
    ...
    @Test
    public void testBnodesSuppressed() throws ClientProtocolException, IOException {
    ...
    @Test
    public void testPageOnItemEndpointGeneratesBadRequest() throws ClientProtocolException, IOException {
        Util.testHttpRequest("show/item/A?_page=1", EldaException.BAD_REQUEST, Util.ignore);
    }

    @Test
    public void testPageSizeOnItemEndpointGeneratesBadRequest() throws ClientProtocolException, IOException {
